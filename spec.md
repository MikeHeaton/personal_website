...
- `lib/display-data.mjs` fetches and validates bounded Open-Meteo data, selects the local-midnight 48-hour forecast window and its two dates' sunrise/sunset values, and controls weather caching and refresh clocks.
