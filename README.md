...
- `lib/display/scene.mjs`: named layout frames, palette/typography choices, deterministic hourly quotations, agenda lists, weather panels, and the midnight-based 48-hour chart.
