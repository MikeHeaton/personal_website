...
export const HABITS = Object.freeze([
  Object.freeze({ key: "dogTeeth", label: "Keke teeth brushing" }),
  Object.freeze({ key: "bed", label: "In bed early" }),
  Object.freeze({ key: "strengthProtein", label: "Took creatine" }),
  Object.freeze({ key: "strengthRun", label: "Did exercise" }),
]);
