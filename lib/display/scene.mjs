...
export function hourlyChart(weather, frame = layout.chart, serverTime = Date.now()) {
  ...
  return `<g id="hourly-chart" role="group" aria-label="Alternating weather charts"><g id="next-24-hours-chart" role="img" aria-label="Next 24 hours: temperature in degrees Fahrenheit and predicted rainfall in inches" visibility="visible">${rolling}<animate attributeName="visibility" calcMode="discrete" values="visible;visible;hidden;hidden;visible" keyTimes="0;0.499;0.5;0.999;1" dur="60s" repeatCount="indefinite"/></g><g id="today-tomorrow-chart" role="img" aria-label="Today and tomorrow: 48 hourly temperature and rainfall forecasts; elapsed time is shaded" visibility="hidden">${twoDay}<animate attributeName="visibility" calcMode="discrete" values="hidden;hidden;visible;visible;hidden" keyTimes="0;0.499;0.5;0.999;1" dur="60s" repeatCount="indefinite"/></g></g>`;
}
